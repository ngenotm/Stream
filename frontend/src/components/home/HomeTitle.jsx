...
import useCounterStore from "../../stores/countreStore";
...
const HomeTitle = () => {
    ...
    return (
        <section className="relative -top-20 pt-4">
            ...
            <h3 className="text-center text-c-grey-60 3xl:text-2xl lg:text-xl md:text-lg text-sm mb-5 mx-auto xl:w-3/5 md:w-3/4 max-md:px-10 max-sm:px-5">
                <button className="bg-slate-600 p-3 rounded-lg" onClick={decrement}>-</button>
                {count}
                <button className="bg-slate-600 p-3 rounded-lg" onClick={increment}>+</button>
            </h3>
            <p
