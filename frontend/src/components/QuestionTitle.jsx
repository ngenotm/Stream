const QuestionTitle = () => {
    return (
        <div className="flex md:flex-row flex-col md:items-end items-start md:gap-6 gap-3">
            ...
            <button className="bg-c-red-45 text-white text-super-sm 3xl:text-xl 3xl:py-3 lg:py-2 md:py-1.5 py-2 3xl:px-6 lg:px-5 px-3.5 rounded">Ask a Question</button>
        </div>
    );
}
